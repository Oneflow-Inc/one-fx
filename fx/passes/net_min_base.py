...
class _MinimizerBase:
    ...
    def run_a(self, mod: fx.GraphModule, inputs: Tensors) -> TensorOrTensors:
        """
    ...
    def run_b(self, mod: fx.GraphModule, inputs: Tensors) -> TensorOrTensors:
        """
        Run `mod` with `inputs` and generate output. The output will be compared with
        output of run_a().
        """
    ...
    def _store_outputs(
        ...
        # Only one output
        if isinstance(output_node.args[0], fx.Node):
    ...
    def _get_submod_inputs(
        self, main_module: fx.GraphModule, submod_path: str
    ...
    def _build_submodule(self, nodes: NodeSet) -> Tuple[fx.GraphModule, str]:
        """
        ...
        Returns:
            split_module (fx.GraphModule): the module after split.
    ...
    def _run_and_compare(
        self, split_module: fx.GraphModule, submod_name: str, output_names: Names
    ):
        """
