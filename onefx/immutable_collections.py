"""
Modified from https://github.com/pytorch/pytorch/blob/master/torch/fx/immutable_collections.py
"""

from typing import Any, Dict, Tuple, List

from ._compatibility import compatibility
from onefx.utils._pytree import Context, _register_pytree_node

__all__ = ["immutable_list", "immutable_dict"]

_help_mutation = """\
If you are attempting to modify the kwargs or args of a onefx.Node object,
