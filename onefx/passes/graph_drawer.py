...
if HAS_PYDOT:
    ...
    class FxGraphDrawer:
        """
        Visualize a onefx.Graph with graphviz
        Basic usage:
        ...
        def __init__(
            self,
            graph_module: onefx.GraphModule,
            name: str,
            ...
            for node in graph_module.graph.nodes:
                ...
                if not isinstance(leaf_node, onefx.GraphModule):
                    continue
        ...
        def _get_node_style(self, node: onefx.Node) -> Dict[str, str]:
            template = {
                "shape": "record",
                "fillcolor": "#CAFFE3",
                "style": '"filled,rounded"',
        ...
        def _get_leaf_node(
            self, module: oneflow.nn.Module, node: onefx.Node
        ) -> oneflow.nn.Module:
            py_obj = module
        ...
        def _to_dot(
            ...
            """
            Actual interface to visualize a onefx.Graph. Note that it takes in the GraphModule instead of the Graph.
    ...
    if not TYPE_CHECKING:
        @compatibility(is_backward_compatible=False)
        class FxGraphDrawer:
            def __init__(self, graph_module: onefx.GraphModule, name: str, ignore_getattr: bool = False):
