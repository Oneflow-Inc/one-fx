...
from onefx.passes.tools_common import NodeList, NodeSet, legalize_graph
from onefx.passes.utils import lift_subgraph_as_module
...
def insert_subgm(gm: GraphModule, sub_gm: GraphModule, orig_inputs: Tuple[Node, ...], orig_outputs: Tuple[Node, ...]):
    ...
    if len(orig_outputs) == 1:
        ...
        for i, orig_output in enumerate(orig_outputs):
            ...
            proxy_out = onefx.Proxy(module_node)[i].node  # type: ignore[index]
