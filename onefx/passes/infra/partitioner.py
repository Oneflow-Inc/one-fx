...
from onefx.passes.utils.fuser_utils import fuse_by_partitions

from onefx.graph_module import GraphModule
from onefx.node import Node, _get_qualified_name
from onefx.passes.operator_support import OperatorSupportBase
